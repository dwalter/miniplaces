...
#####################################################
#####################################################
####### moved training params to bottom of file #####
#####################################################
#####################################################
...
def main_test():    
    ...
    loader_test = DataLoaderDisk(is_test=True,**opt_data_test)
    ...
    with tf.Session() as sess:
        ...
        for i in range(num_batch):
            ...
            acc1, acc5 = sess.run([accuracy1, accuracy5], feed_dict={x: images_batch, keep_dropout: 1.})
            acc1_total += acc1
            acc5_total += acc5
            print("Validation Accuracy Top1 = " + \
                  "{:.2f}".format(acc1) + ", Top5 = " + \
